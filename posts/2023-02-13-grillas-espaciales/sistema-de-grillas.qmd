...
```{r}
g_8km <- st_read(here("vectors/grid_8km.gpkg"))
g_4km <- st_read(here("vectors/grid_4km.gpkg"))
g_2km <- st_read(here("vectors/grid_2km.gpkg"))
g_1km <- st_read(here("vectors/grid_1km.gpkg"))
```
...
gg_grilla <- import(here("data/gg_grilla_8km.xlsx"))
...
gg_grilla <- import(here("data/gg_grilla_4km.xlsx"))
ggplot(gg_grilla, aes(x, y)) +
  theme_minimal() +
  geom_tile(aes(fill = color), color = "black") +
  geom_text(aes(label = celda), color = "black", size = 3) +
...
gg_grilla <- import(here("data/gg_grilla_2km.xlsx"))
ggplot(gg_grilla, aes(x, y)) +
  theme_minimal() +
  geom_tile(aes(fill = color), color = "black") +
  geom_text(aes(label = celda), color = "black", size = 3) +
...
gg_grilla <- import(here("data/gg_grilla_1km.xlsx"))
ggplot(gg_grilla, aes(x, y)) +
  theme_minimal() +
  geom_tile(aes(fill = color), color = "black") +
  geom_text(aes(label = celda), color = "black", size = 3) +
