...
subtitle: "cacc es un paquete de R con funciones para bajar información climática para el análisis del impacto del cambio climático en América Central"
image: "imagenes/cacc_a.png"
author:
  - name: Manuel Spínola
...
#| fig-align: center
library(knitr)
include_graphics("imagenes/cacc_a.png")
```
...
**ca_historic_worldclim**: permite bajar información climática histórica (cercana al presente) para América Central desde [WorldClim](https://www.worldclim.org/).

**ca_future_worldclim**: permite bajar información climática de condiciones futuras para América Central desde [WorldClim](https://www.worldclim.org/).
